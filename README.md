...
本项目是 **医院后台管理系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-167-springboot-yuan-hou-tai-guan-li`

**原始压缩包名**：`springboot167基于springboot的医院后台管理系统的设计与实现`
